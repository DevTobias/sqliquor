  ...
  return (
    <group {...props} dispose={null}>
      <group position={[-61.13, 0, -158.997]} rotation={[0, 1.571, 0]} scale={5.657}>
        <mesh geometry={nodes.Mesh_Buildings_House_01005.geometry} material={materials['door.002']} />
        <mesh geometry={nodes.Mesh_Buildings_House_01005_1.geometry} material={materials['M_LowPolyMegapolis_Light.002']} />
        <mesh geometry={nodes.Mesh_Buildings_House_01005_2.geometry} material={materials['M_LowPolyMegapolis_Glass.002']} />
        <mesh geometry={nodes.Mesh_Buildings_House_01005_3.geometry} material={materials['M_LowPolyMegapolis_MAIN.007']} />
      </group>
    </group>
  );
};
